# Managing OpenShift/Kubernetes clusters using RHACM and Argo CD
...
If the reconcilitaion of objects on the cluster fails, we would like Argo CD to keep trying. This is what other operators typically do, they keep trying until the object is successfully reconciled.
